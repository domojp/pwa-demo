...
- Renamed repo from `test` to `platform-scaffold`
...
- Fix for add-to-cart when Magento Full Page Cache is enabled [#406](https://github.com/mobify/test/pull/406)
...
- Updated to v0.13.0 of the SDK [#361](https://github.com/mobify/test/pull/361)
- Rename app-provider.jsx to router.jsx [#354](https://github.com/mobify/test/pull/354)
- Rename raw to unwrapped in templates.jsx [#354](https://github.com/mobify/test/pull/354)
...
- Remove react-hot-loader [#106](https://github.com/mobify/test/pull/106)
- Add npm script alias for generating form components [#105](https://github.com/mobify/test/pull/105)
